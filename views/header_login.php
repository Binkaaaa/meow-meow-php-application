...
<body class="font-sans bg-white">
    ...
    <header class="bg-black text-yellow-200 font-bold">
        <div class="container mx-auto flex justify-between items-center py-2 px-6 text-sm">
            ...
            <div class="flex space-x-2">
                <a href="/petstore/views/user-profile.php" class="hover:underline font-bold"> Profile</a>
                <p> | </p>
                <a href="/petstore/index.php" class="hover:underline font-bold"> Logout</a>
            </div>
        </div>
    </header>
    ...
    <nav class="bg-white shadow-md">
        <div class="container mx-auto flex items-center justify-between py-4 px-6">
            ...
            <div class="flex items-center space-x-10 ">
                <div class="relative w-96 mx-auto">
                    ...
                    <a href="/petstore/views/cart.php">
                        <button class="hover:text-gray-900 flex items-center px-4 py-2">
                        <img src="/petstore/public/uploads/shopping-cart.png" alt="cart" class="w-6 h-6">
                        </button>
                    </a>
                    <a href="/petstore/views/checkout.php"> 
                    <button class="px-6 py-2 bg-yellow-300 text-black font-extrabold rounded-lg hover:bg-black hover:text-yellow-200 transition duration-300">CHECKOUT</button>
        ...
        <a href="/petstore/views/user-dashboard.php" class="text-yellow-200 font-extrabold hover:underline">HOME</a>
        <a href="/petstore/views/items-login.php" class="text-yellow-200 font-extrabold hover:underline">PRODUCTS</a>
        <a href="/petstore/views/about-login.php" class="text-yellow-200 font-extrabold hover:underline">ABOUT</a>
        <a href="/petstore/views/contactus-login.php" class="text-yellow-200 font-extrabold hover:underline">CONTACT US</a>
    </div>
</div>
